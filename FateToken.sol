...
contract FateToken is IERC20, Ownable {
    ...
    // token data
    string private constant _name = "FateToken";
    string private constant _symbol = "$FATE";
    ...
    constructor() {
        ...
        _totalSupply = 777777777 * 10**_decimals;

        // max sell transaction
        max_sell_transaction_limit = 1 * 10**6 * 10**18;
    ...
    function setMaxSellTransactionLimit(uint256 maxSellTransactionLimit)
        external
        onlyOwner
    {
        require(
